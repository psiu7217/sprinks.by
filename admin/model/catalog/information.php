...
class ModelCatalogInformation extends Model {
	...
	public function editInformation($information_id, $data) {
		...
		foreach ($data['information_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "information_description SET information_id = '" . (int)$information_id . "', language_id = '" . (int)$language_id . "', title = '" . $this->db->escape($value['title']) . "', description = '" . $this->db->escape($value['description']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', template = '" . $this->db->escape($value['template']) . "', min_descr = '" . $this->db->escape($value['min_descr']) . "', image = '" . $this->db->escape($value['image']) . "', btn_text = '" . $this->db->escape($value['btn_text']) . "', problem = '" . $this->db->escape($value['problem']) . "', order_answer = '" . $this->db->escape($value['order_answer']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
		}
	...
	public function getInformationDescriptions($information_id) {
		...
		foreach ($query->rows as $result) {
			$information_description_data[$result['language_id']] = array(
                ...
                'min_descr'     => $result['min_descr'],
                'image'     => $result['image'],
                'btn_text'     => $result['btn_text'],
                'problem'     => $result['problem'],
                'order_answer'     => $result['order_answer'],
			);
		}
