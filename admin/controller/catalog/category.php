...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['brand_menu'])) {
            $data['brand_menu'] = $this->request->post['brand_menu'];
        } elseif (!empty($category_info)) {
            $data['brand_menu'] = $category_info['brand_menu'];
        } else {
            $data['brand_menu'] = 0;
        }
        if (isset($this->request->post['no_left_menu'])) {
            $data['no_left_menu'] = $this->request->post['no_left_menu'];
        } elseif (!empty($category_info)) {
            $data['no_left_menu'] = $category_info['no_left_menu'];
        } else {
            $data['no_left_menu'] = 0;
        }
